...
function message(msg, title='系统', error=false) {
    toastr.options = {
        "closeButton": true,
        "debug": false,
        "progressBar": true,
